...
function Products() {
    ...
    // useMemo per ordinare i prodotti evitando ricalcoli costosi
    const orderedProducts = useMemo(() => {
        ...
        } else if (ordered === "titleZa") {
            copy.sort((a, b) =>
                b.title.toLowerCase().localeCompare(a.title.toLowerCase())
            );
        } else if (ordered === "categoryAz") {
            copy.sort((a, b) =>
                a.category.toLowerCase().localeCompare(b.category.toLowerCase())
            );
        } else if (ordered === "categoryZa") {
            copy.sort((a, b) =>
    ...
    return <>
        ...
        <div className="container">
            ...
            <div className="d-flex justify-content-center w-100 gap-2 flex-wrap">
                ...
                <div className="col-12 col-md-4 col-lg-3">
                    <select value={ordered} className="form-select" onChange={(e) => setOrdered(e.target.value)} ref={scroll}>
                    ...
                    <div className="row">
                        {orderedProducts.map((p, i) => (
                            <ProductCard
                                ...
                                toggleFavourites={() => toggleFavourites(p)}
                            />
                        ))
                        }
                    </div>
...
//     // funzione useCallback per il debounce della ricerca
//     const debounceSearch = useCallback(
//         debounce((value) => setSearch(value), 500),
//         []
//     );

//     // al montaggio / cambiamento filtri aggiorno i prodotti
//     useEffect(() => {
//         getProducts(search, category);
//     }, [search, category]);
...
//     // useMemo per ordinare i prodotti senza toccare lo state
//     const orderedProducts = useMemo(() => {
//         let copy = [...products];
...
//                     <h1 className="text-white py-5 text-center">Nessun Dispositivo Trovato</h1>
//                 ) : (
//                     <div className="mt-2 py-2">
//                         <div className="row">
//                             {orderedProducts.map((p, i) => (
